...
export default class networkAddMembers extends Component {
  constructor(props) {
    super(props);
    this.state = {
      network_data: [],
  ...
  InviteNetwork() {
    ...
    var result = number
      .map(function(val) {
        return val.phone?val.phone:false;
      })
      .join(",");
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <View style={styles.headercenter}>
            <Text style={styles.header_title}> Invite User </Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <TouchableOpacity style={styles} onPress={() => this.InviteNetwork()}>
            <Text style={styles.footjumbotxt}> Invite</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
...
module.exports = connect(mapStateToProps)(networkAddMembers);
