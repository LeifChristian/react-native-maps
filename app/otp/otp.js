...
class otp_verification extends Component {
  constructor(props) {
    super(props);
    this.state = { otp1: "", otp2: "", ot3: "", otp4: "", otp5: "", otp6: "" };
 ...
 focusNextField(id) {
  ...
  otp_verificatoin() {
    let url = loginUrl + "user/matchOtp";
    let method = "POST";
    let otpnumber =
      this.state.otp1 +
      this.state.otp2 +
    ...
    dataLayer
      ...
      .then(responseJson => {
        if (responseJson.status == "true") {
          AsyncStorage.setItem("otp_data", JSON.stringify(responseJson.data));
...
module.exports = connect(mapStateToProps)(otp_verification);
